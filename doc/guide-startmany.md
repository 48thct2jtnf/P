...
2. [Sending 20,000 Phore to new wallet addresses.](#option2)
...
### Send 20,000 Phore to New Addresses

Just like setting up a standard MN. Send exactly 20,000 Phore to each new address created above.
...
[From the phore github repo](https://github.com/phore-project/phore/blob/master/doc/masternode_conf.md)
...
And compare with the official explorer at http://
